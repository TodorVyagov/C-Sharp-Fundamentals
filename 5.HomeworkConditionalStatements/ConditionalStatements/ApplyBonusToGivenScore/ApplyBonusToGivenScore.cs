...
namespace ApplyBonusToGivenScore
{
    class ApplyBonusToGivenScore
    {
        static void Main()
        {
            ...
            switch (digit)
            {
                ...
                case 3:
                    digit *= 10;
                    Console.WriteLine("Your digit was multiplied by 10 and the result is = " + digit);
                    break;                
                case 4:  
                case 5:  
                case 6:
                    digit *= 100;
                    Console.WriteLine("Your digit was multiplied by 100 and the result is = " + digit);
                    break;               
                case 7:
                case 8: 
                case 9:
                    digit *= 1000;
                    Console.WriteLine("Your digit was multiplied by 1000 and the result is = " + digit);
                    break;
                default: 
